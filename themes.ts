...
export const themes: Record<string, Theme> = {
  ...
  synthwave: {
    name: 'Synthwave',
    body: 'bg-[#1f1e1f] text-[#f7ffff]',
    header: 'text-[#d7db01]',
    buttonPrimary: 'bg-[#cdd800] hover:bg-[#e0e83b] text-[#073630]',
    buttonSecondary: 'bg-[#676666] hover:bg-[#7a7979] text-[#f7ffff]',
    buttonDanger: 'bg-red-600 hover:bg-red-500 text-white',
    buttonIconHoverBg: 'hover:bg-[#676666]',
    buttonIconHoverText: 'hover:text-white',
    modalBg: 'bg-[#055471]',
    modalText: 'text-[#f7ffff]',
    modalMutedText: 'text-slate-300',
    inputBg: 'bg-black/30 border-[#676666] text-[#f7ffff]',
    inputFocusRing: 'focus:ring-[#cdd800] focus:border-[#cdd800]',
    columnBg: 'bg-[#1f1e1f]/50',
    groupBg: 'bg-[#009ad8]/90',
    groupBgSecondary: 'bg-[#055471]/90',
    groupBgTertiary: 'bg-[#cdd800]/20',
    linkBg: 'bg-[#055471]/50',
    linkHoverBg: 'hover:bg-[#055471]',
    linkText: 'text-[#f7ffff]',
    linkHoverText: 'hover:text-[#d7db01]',
    iconMuted: 'text-slate-400',
    ring: 'ring-[#cdd800]',
    dashedBorder: 'border-[#676666]',
    textMuted: 'text-slate-400',
    textSubtle: 'text-slate-600',
    scrollbarTrack: '#1f1e1f',
    scrollbarThumb: '#676666',
    scrollbarThumbHover: '#cdd800',
  },
  coffee: {
    name: 'Coffee',
  ...
  cyber: {
    ...
    modalBg: 'bg-fuchsia-950',  //BAKGRUND PÅ T.EX. Settings rutan
    modalText: 'text-lime-400', //TEXTFÄRG I SETTINGS RUTOR typ      
    modalMutedText: 'text-slate-300', //ANDRA TEXTFÄRGEN i SETTINGS RUTOR TYP
    inputBg: 'bg-slate-900 border-fuchsia-800 text-lime-300',
    inputFocusRing: 'focus:ring-lime-500 focus:border-lime-500',
    columnBg: 'bg-slate-950/0', //BAKGRUND KOLUMNERNA /0 = helt genomskinlig, 100 = ogenomskinlig
    groupBg: 'bg-slate-900/40', //BAKGRUND GRUPPER
    ...
    iconMuted: 'text-slate-100',  //TEXT-IKON FÄRG PÅ Delete
    ring: 'ring-lime-500',
    dashedBorder: 'border-fuchsia-600', //STRECKADE LINJEN RUNT TOMMA SAKER TYP
    textMuted: 'text-[#ffffff]',
    textSubtle: 'text-slate-100',
